        ...
        >
          <Tooltip title="Container" placement="right">
            <Item $move>
              ...
              <Image src={SquareSvg} alt="Square Icon" width={24} height={24} />;
            </Item>
          </Tooltip>
        </div>
        <div
        ...
        >
          <Tooltip title="Text" placement="right">
            <Item $move>
              ...
              <Image src={TypeSvg} alt="Square Icon" width={28} height={28} />;
            </Item>
          </Tooltip>
        </div>
        <div
        ...
        >
          <Tooltip title="Button" placement="right">
            <Item $move>
              ...
              <Image src={ButtonSvg} alt="Square Icon" width={24} height={24} />;
            </Item>
          </Tooltip>
        </div>
        <div
        ...
        >
          <Tooltip title="Video" placement="right">
            <Item $move>
              ...
              <Image src={YoutubeSvg} alt="Square Icon" width={28} height={28} />;
            </Item>
          </Tooltip>
        </div>
      </div>
